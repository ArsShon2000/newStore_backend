...
class BoilerParts {
    ...
    @ApiProperty({ example: "2023-07-09T01:56:07.000Z" })
    createdAt: string;
...
export class SearchByLettersResponse extends BoilerParts {
    @ApiProperty({ example: "Arisu Temarisu." })
    name: string;
}

export class SearchResponse extends PaginateAndFilterResponse {
    @ApiProperty({ type: SearchByLettersResponse, isArray: true })
    rows: SearchByLettersResponse;
}
